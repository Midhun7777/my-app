            ...
            {[
              {
                name: 'Basic',
                price: 'Free',
                features: ['Up to 5 departments', 'Basic asset tracking', 'Email support']
              },
              {
                name: 'Pro',
                price: '$99/mo',
                features: ['Unlimited departments', 'Advanced analytics', 'Priority support', 'Custom reports']
              },
              {
                name: 'Enterprise',
                price: 'Custom',
      ...
      <section id="testimonials" className="py-20 bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-20 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {[
              {
                quote: "This system has revolutionized how we manage our department's assets. Highly recommended!",
                author: "John Doe",
                role: "IT Department Head"
              },
              {
                quote: "The admin dashboard is intuitive and powerful. Makes my job so much easier.",
                author: "Jane Smith",
                role: "Asset Manager"
              },
              {
                quote: "Best asset management solution we've used. The support team is excellent.",
                author: "Mike Johnson",
